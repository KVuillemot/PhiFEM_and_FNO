...
class Loss(object):
    ...
    def compute_loss(self, X, y_pred, y_true, mode, level, plot=False):
    ...
    def __call__(self, X, y_pred, y_true, mode, level=2, plot=False):
        return self.compute_loss(X, y_pred, y_true, mode, level, plot)
