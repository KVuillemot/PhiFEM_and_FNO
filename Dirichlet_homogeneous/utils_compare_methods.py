...
def compute_standard_fem(nb_vert, param, exact_fem=False):
    mu0, mu1, sigma, x_0, y_0, lx, ly, theta = param
    print(f"(mu0, mu1, sigma, x_0, y_0, lx, ly, theta) = {param}")
...
class PhiFemSolver_error:
    ...
    def solve_one(self, i):
        mu0, mu1, sigma, x_0, y_0, lx, ly, theta = self.params
        print(f"(mu0, mu1, sigma, x_0, y_0, lx, ly, theta) = {self.params}")
