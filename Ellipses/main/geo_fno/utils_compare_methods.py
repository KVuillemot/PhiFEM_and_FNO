...
class points2mesh:
    ...
    def create_standard_mesh(self, points):
        ...
        command_1 = "mmg2d_O3 -noinsert -nomove -in points.mesh -out mesh.mesh -v 0"  # optimize the mesh, keeping the nb of vertices fixed
        os.system(command_1)
...
class StandardFEMSolver:
    ...
    def solve_one(self, i, size, nb_vert=64, reference_fem=False, force_deg2=False):
        ...
        fdim = tdim - 1
        start_locate_boundaries = time.time()
        ...
        end_locate_boundaries = time.time()
        list_times.append(end_locate_boundaries - start_locate_boundaries)
...
class PhiFemSolver_error:
    ...
    def solve_one(self, i, force_deg2=False):
        ...
        total_time = cell_selection + submesh_construction
        # End Construction of Omega_h

        list_times = [self.init_time, cell_selection, submesh_construction]
        ...
        phi_values = call_phi(points, x_0, y_0, lx, ly, theta).flatten()
        phi_j = phi_values[:]
        ...
        total_time += ghost_cell_selection
        list_times.append(ghost_cell_selection)
        ...
        list_times.append(resolution_time)
